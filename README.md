...
| id（课程表的主键） | teacher_id（教师号） | capacity（容量） | enrollment（已选人数） | time（上课时间） | location（上课地点） | term（开设学期） |
| ------------------ | -------------------- | ---------------- | ---------------------- | ---------------- | -------------------- | ---------------- |
|                    |                      |                  |                        |                  |                      |                  |
|                    |                      |                  |                        |                  |                      |                  |
...
| student_id（学号） | class_id（课程号） | teacher_id（教师号） | usually_score（平时成绩) | test_score（考试成绩） | total_score（最终成绩） | term(开设学期) |
| ------------------ | ------------------ | -------------------- | ------------------------ | ---------------------- | ----------------------- | -------------- |
|                    |                    |                      |                          |                        |                         |                |
|                    |                    |                      |                          |                        |                         |                |
|                    |                    |                      |                          |                        |                         |                |
